...
const ArtisanDashboard = () => {
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!validTypes.includes(file.type)) {
      toast.error('Format de fichier non pris en charge. Veuillez télécharger une image JPG ou PNG.')
      return
    }
                  ...
                  <Card className="rounded-xs shadow-lg">
                    ...
                    <CardContent>
                      <form className="space-y-4">
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="product-image">Image de l'article *</Label>
                          <div className="border-2 border-dashed border-sand-300 p-6 rounded-md text-center">
                            <Image className="h-12 w-12 mx-auto text-primary mb-2" />
                            <p className="text-sm text-foreground mb-2">
                              Téléchargez une image (JPG, JPEG, PNG, max 5MB)
                            </p>
                            <input
                              id="product-image"
                              type="file"
                            ...
                            >
                              {productImage ? 'Changer l\'image' : 'Sélectionner une image'}
                            </Button>
                            {productImage && (
                              <div className="mt-3">
